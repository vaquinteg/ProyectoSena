...
//$identificacion=1234;
if ($identificacion === 0) {
    die(json_encode(['error' => 'El parámetro identificacion no fue enviado correctamente']));
}
// Preparar y ejecutar la consulta
$sql = "SELECT idUsuario, nombre, email, rol, identificacion, tipo_documento, telefono, direccion
