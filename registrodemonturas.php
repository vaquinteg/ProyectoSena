...
<div class="container-fluid row m-1">
  <h6 class="ntitulo" style="text-align: center;"> Registro de montura</h6>
   ...
   <h2 class= "lmm"> <a class = "ablink" href="listamarcamontura.php">Lista de monturas</a> </h2>
          ...
          <form id="formulario_montura_marca_posicion" action="php/select_marca_montura_posicion.php" method="post" >
           ...
           <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-between"><input type="text" name="material" id="material" class="es3 primary2" required></div>
          </div>

          <div class="row">
            <div class="col-md-6 d-flex justify-content-between"><label for="color">Color:</label></div>
            <div class="col-md-6 d-flex justify-content-between"><input type="text" name="color" id="color" class="es3 primary2" required></div>
          </div>

          <div class="row">
            <div class="col-md-6 d-flex justify-content-between"><label for="precio"> Precio $ </label></div>
            <div class="col-md-6 d-flex justify-content-between"><input type="number" name="precio" id="precio" class="es3 primary2" required></div>
          </div>

          <div class="row">
            <div class="col-md-6 d-flex justify-content-between"><label for="referencia"> Referencia</label></div>
            <div class="col-md-6 d-flex justify-content-between"><input type="text" name="referencia" id="referencia" class="es3 primary2" required></div>
          </div>
    ...
    <div class="row">         
            <img src="imagen/gafasopticanaan2.jpg" alt="foto" width="765" height="531" class="imag2" >
